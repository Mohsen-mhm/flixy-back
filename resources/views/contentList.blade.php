...
@section('script')
    ...
    <script>
        ...
        $('.nav-tabs button').on('shown.bs.tab', function (event) {
            ...
            if (activeTab === "nav-series-tab") {
                $('#TMDB_Button').attr("href", "{{ route('fetchContentFromTMDB') }}?tab=series");
            } else if (activeTab === "nav-movies-tab") {
                $('#TMDB_Button').attr("href", "{{ route('fetchContentFromTMDB') }}?tab=movies");
            }
        });
    </script>
@endsection
    ...
    <section class="section">
        ...
        <div class="card">
                ...
                <div class="page-title w-100">
                    <div class="d-block d-xl-flex align-items-center justify-content-between gap-2">
                        <div class="d-block d-xl-flex align-items-center justify-content-between">
                            ...
                            <nav class="card-tab mt-2 mt-xl-0">
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button class="nav-link active" id="nav-movies-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-movies" type="button" role="tab"
                                            aria-controls="nav-movies" aria-selected="false">
                                        {{ __('movies') }}
                                    </button>
                                    <button class="nav-link" id="nav-series-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-series" type="button" role="tab"
                                            aria-controls="nav-series" aria-selected="false">
                                        {{ __('series') }}
                                    </button>
                                </div>
                            </nav>
                        ...
                        <div class="d-block d-sm-flex align-items-center justify-content-end">
                            <button type="button" class="btn btn-primary text-light px-4 me-2 mt-3 mb-xl-0"
                                    data-bs-toggle="modal" data-bs-target="#addContentModal">
                                {{ __('addContent') }}
                            </button>
                            <a href="{{ route('fetchContentFromTMDB') }}" id="TMDB_Button"
                               class="btn btn-tmdb shadow-none text-light px-4 mt-3 mb-xl-0">
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane show active" id="nav-movies" role="tabpanel" aria-labelledby="nav-movies-tab"
                     tabindex="0">
                    <div class="card-body">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="selectGenre" class="form-label">{{ __('selectGenre') }}
                                        ({{ __('multiple') }})</label>
                                    <select name="genre_ids[]" class="form-control selectric" id="selectGenre"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="release_year" type="number" class="form-control"
                                                   id="release_year" aria-describedby="release_year" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="rating_star">
                                                ...
                                                <input name="ratings" type="number" step=any class="form-control"
                                                       id="ratings" aria-describedby="rating" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="upload-options">
                                                <label for="poster">
                                                    <input name="vertical_poster" type="file"
                                                           ...
                                                           onchange="loadFile(event, 'vertical_poster')" id="poster"
                                                           required>
                                                </label>
                                            </div>
                                            <img id="vertical_poster"
                                            ...
                                            <div class="upload-options">
                                                <label for="horizontalPoster">
                                                    <input name="horizontal_poster" type="file"
                                                           accept=".png, .jpg, .jpeg, .webp"
                                                           onchange="loadFile(event, 'horizontalPosterImg')"
                                                           id="horizontalPoster" required>
                                                </label>
                                            </div>
                                            <img id="horizontalPosterImg"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="trailer_url" type="text" class="form-control"
                                                   id="edit_trailer_url" aria-describedby="trailer_url" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="d-block d-md-flex">
